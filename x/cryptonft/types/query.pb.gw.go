...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"devashishdxt", "cryptonft", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Class_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"devashishdxt", "cryptonft", "class", "classId"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Classes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"devashishdxt", "cryptonft", "classes"}, "", runtime.AssumeColonVerbOpt(true)))
)
